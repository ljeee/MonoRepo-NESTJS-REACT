...
import { Producto, ProductoVariante, useProductOperations, useProductos } from './use-productos';
import { PizzaSabor, usePizzaSabores, useUpdatePizzaSabor } from './use-pizza-sabores';

type DeleteTarget = { type: 'product' | 'variant'; id: number; name: string } | null;
