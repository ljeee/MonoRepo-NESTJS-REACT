    ...
    return (
        ...
        >
            <PageHeader
                ...
                subtitle="Administra tu carta y precios"
                icon="food-variant"
                rightContent={
                    <Button
            ...
            <GestionProductosModals
                ...
                prodDesc={prodDesc}
                prodEmoji={prodEmoji}
                prodPersonalizacion={prodPersonalizacion}
                prodError={prodError}
                ...
                onProdPersonalizacionChange={(v) => patchUi({ prodPersonalizacion: v })}
                ...
                onCloseSabor={() => patchUi({ editingSabor: null })}
            />
        </PageContainer>
    );
}
